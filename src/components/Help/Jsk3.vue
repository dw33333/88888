<template>
  <div id="js_k3" class="ruleset" style="padding:30px;">
					<div class="content">
						<ul>
							<li>1.「江苏快3」由中国福利彩票发行管理中心组织销售、江苏省福利彩票发行中心承销。</li>
							<li>2.开奖时间：每日早上8点30分至晚上10点10分；每日共开奖82期、每 10 分钟开奖 1 次。</li>
							<li>3.每期开出3个号码、每个号码范围01~06 。</li>
							<li>4.如开奖时间异动以中国福利彩票管理中心公告为准。
								<br>
								<strong>官方网站</strong>：<a target="_blank" href="http://www.jslottery.com/">http://www.jslottery.com/</a>
<!--								<br> 即时开奖：
								<a target="_blank" href="http://www.shishicai.cn/jsk3/touzhu/">http://www.shishicai.cn/jsk3/touzhu/</a>-->
							</li>
						</ul>
						<br>
						...
						<ul>
							<li>
                                ...
                                <ul>
									...
									<li>单双：三个开奖号码总和5、7、9、11、13、15、17为单；4、6、8、10、12、14、16、18为双；若三个号码相同、则不算中奖。</li>
								</ul>
							</li>
						</ul>
