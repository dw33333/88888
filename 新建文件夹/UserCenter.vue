<template>
  <div class='container usercenter'>
    ...
    <div class="main-body">
      <div class='select'>
        <div class="account">
          账号: <span style="font-size: 12px;">{{userinfo.username}}</span>
        </div>
        <div class="balance">
        ...
        <div class="sidebar">
          <div class="sidebar-menu">
            <div class="item" @click="isShow(1)" v-if="userinfo.virtual!==1">
              <a  href="javascript:void(0);">密码管理</a>
            </div>
            <ul class='list-item' :style="{height:isDisplay==1?((30*1)+'px'):'0px',visibility:isDisplay==1?'visible':'hidden',overflow:'hidden'}" v-if="userinfo.virtual!==1">
              <li>
            ...
            <ul class="list-item"
                :style="{height:isDisplay==2?((30*(userinfo.virtual!==1?3:2))+'px'):'0px',visibility:isDisplay==2?'visible':'hidden',overflow:'hidden'}">
              <li v-if="userinfo.virtual!==1">
           ...
           <div class="item" @click="isShow(3)" v-if="userinfo.virtual!==1">
              <a href="javascript:void(0);">额度转换</a>
            </div>
            <ul class='list-item'
                :style="{height:isDisplay==3?((34*2)+'px'):'0px',visibility:isDisplay==3?'visible':'hidden',overflow:'hidden'}">
              <li>
                <router-link class="full" to="/moneymanagemen">额度管理</router-link>
              </li>
              <li>
                <router-link class="full" to="/transRecord">转换记录</router-link>
              </li>
            </ul>
