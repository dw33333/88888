<template>
  <div class="rule_from02"> <strong>北京赛车开奖时间：</strong>
				  ...
				  <h2>两面盘（冠亚和）: "冠军车号 + 亚军车号 = 冠亚和"</h2>
					两面盘和大小∶以冠军车号和亚军车号之和大小来判断胜负，"冠亚和"大於11为大，小於或等於11为小。假如投注组合符合中奖结果，视为中奖，其馀情形视为不中奖。<br>
					两面盘和单双∶以冠军车号和亚军车号之和单双来判断胜负，"冠亚和"为双数叫双，为单数叫单。 假如投注组合符合中奖结果，视为中奖，其馀情形视为不中奖。<br>
					两面盘和指定: 以指定冠军车号和亚军车号之和来判断胜负；冠亚车号总和可能出现结果为3~19，投中对应"冠亚和指定"数字视为中奖，其馀情形视为不中奖<br>
				  <dd>
					<ul>
